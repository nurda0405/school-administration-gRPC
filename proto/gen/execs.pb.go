...
type GetExecsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Student       *Exec                  `protobuf:"bytes,1,opt,name=student,proto3" json:"student,omitempty"`
...
func (x *GetExecsRequest) GetStudent() *Exec {
	if x != nil {
		return x.Student
	}
	return nil
...
const file_execs_proto_rawDesc = "" +
	...
	"\fConfirmation\x12\"\n" +
	"\fconfirmation\x18\x01 \x01(\bR\fconfirmation\"u\n" +
	...
	"\aExecIDs\x12\x1e\n" +
	"\x03ids\x18\x01 \x03(\v2\f.main.ExecIDR\x03ids\"a\n" +
	"\x0fGetExecsRequest\x12$\n" +
	"\astudent\x18\x01 \x01(\v2\n" +
	".main.ExecR\astudent\x12(\n" +
...
var file_execs_proto_goTypes = []any{
	...
	(*ForgotPasswordRequest)(nil),  // 2: main.ForgotPasswordRequest
	...
	(*UpdatePasswordRequest)(nil),  // 6: main.UpdatePasswordRequest
	...
	(*DeleteExecConfirmation)(nil), // 10: main.DeleteExecConfirmation
...
var file_execs_proto_depIdxs = []int32{
	...
	14, // 1: main.GetExecsRequest.student:type_name -> main.Exec
	...
	6,  // 10: main.ExecsService.UpdatePassword:input_type -> main.UpdatePasswordRequest
	4,  // 11: main.ExecsService.ResetPassword:input_type -> main.ResetPasswordRequest
	2,  // 12: main.ExecsService.ForgotPassword:input_type -> main.ForgotPasswordRequest
	...
	10, // 17: main.ExecsService.DeleteExecs:output_type -> main.DeleteExecConfirmation
	...
	7,  // 20: main.ExecsService.UpdatePassword:output_type -> main.UpdatePasswordResponse
