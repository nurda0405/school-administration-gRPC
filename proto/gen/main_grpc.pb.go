...
const (
	...
	TeachersService_GetStudentByClassTeacher_FullMethodName      = "/main.TeachersService/GetStudentByClassTeacher"
...
type TeachersServiceClient interface {
	...
	GetStudentByClassTeacher(ctx context.Context, in *TeacherID, opts ...grpc.CallOption) (*Students, error)
...
func (c *teachersServiceClient) GetStudentByClassTeacher(ctx context.Context, in *TeacherID, opts ...grpc.CallOption) (*Students, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Students)
	err := c.cc.Invoke(ctx, TeachersService_GetStudentByClassTeacher_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TeachersServiceServer interface {
	...
	GetStudentByClassTeacher(context.Context, *TeacherID) (*Students, error)
...
func (UnimplementedTeachersServiceServer) GetStudentByClassTeacher(context.Context, *TeacherID) (*Students, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStudentByClassTeacher not implemented")
}
...
func _TeachersService_GetStudentByClassTeacher_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TeacherID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TeachersServiceServer).GetStudentByClassTeacher(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TeachersService_GetStudentByClassTeacher_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TeachersServiceServer).GetStudentByClassTeacher(ctx, req.(*TeacherID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TeachersService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStudentByClassTeacher",
			Handler:    _TeachersService_GetStudentByClassTeacher_Handler,
		},
		{
